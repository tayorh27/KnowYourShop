...
public class SpecialProducts {
    ...
    public SpecialProducts(int id, int user_id, String shop_name, String product_category, String product_name, String product_price, String product_description, String product_logo, String in_stock,
