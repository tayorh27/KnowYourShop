...
public class Product {
    ...
    public Product(int id, int user_id, String shop_name, String product_category, String product_name, String product_price, String product_description, String product_logo, String in_stock) {
        this.id = id;
